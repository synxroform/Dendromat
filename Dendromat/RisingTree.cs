...
namespace Dendromat
{
	public class RisingTree // основной класс для манипулирования деревом
	{
		static double tolerance = Rhino.RhinoDoc.ActiveDoc.ModelAbsoluteTolerance;
		static double overlap = tolerance;

		BasicTree ownedTree; // низкоуровневое представление дерева как структуры данных.

		public RisingTree(Curve root, List<Curve> crown)
		{
	...
	{
		public Plane Frame; // перпендикулярный фрейм на конце ветки
